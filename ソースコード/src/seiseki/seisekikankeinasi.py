...
data = (data_df3["SAチェック1"].to_list(), data_df3["SAチェック2"].to_list(), data_df3["SAチェック3"].to_list())

print(data_df3["SAチェック1"].to_list())
print("次")
print(data_df3["SAチェック2"].to_list())
print("次")
print(data_df3["SAチェック3"].to_list())
