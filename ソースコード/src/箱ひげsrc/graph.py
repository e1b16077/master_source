...
book = openpyxl.load_workbook('data_pure+.xlsx', read_only=True)
# シートを取得
...
h = graph[1]["IC_lec_sum"].tolist()
r = graph[2]["IN_lec_sum"].tolist()
...
ax1.set_xticklabels(['クラスA(N=82)', 'クラスB(N=77)',
                     'クラスC(N=52)'], fontname="MS Gothic")
